...
image: fun
	...
	@rm -rf root tmp
	@mv images/sdcard.img images/FunKey-sdcard-DrUm78_Mini_GBA.img
...
image-prod: fun
	...
	@rm -rf root tmp
	@mv images/sdcard-prod.img images/FunKey-sdcard-prod-DrUm78_Mini_GBA.img
...
update: fun
	...
	tr " " "\n" | \
	cpio -o -H crc --quiet > ../images/FunKey-rootfs-DrUm78_Mini_GBA.fwu
	@rm -rf tmp
